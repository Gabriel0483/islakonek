              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col items-center justify-center py-6 border-t border-dashed relative">
                  ...
                  <div className="bg-primary/5 p-4 rounded-2xl mb-4 border border-primary/10">
                    <Image 
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=BOARDING_PASS_${lastCreatedBooking?.id}_${lastCreatedBooking?.boardingSequenceNumber}&color=1f3a93&bgcolor=ffffff`}
